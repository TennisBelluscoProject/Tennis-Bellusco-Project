    ...
    return (
      <>
        <div className="bg-gray-50/80 rounded-xl border border-gray-100 px-4 py-3 animate-fade-in">
            ...
            <div className="flex items-center gap-0.5 shrink-0">
              {isMobile && prevStatus && (
                <button
                  ...
                  className="p-2 text-[11px] text-gray-400 hover:text-gray-600 hover:bg-gray-200 rounded-lg transition-colors active:scale-95"
                  title="Riapri"
                >
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="1 4 1 10 7 10" /><path d="M3.51 15a9 9 0 1 0 2.13-9.36L1 10" /></svg>
                </button>
              )}
              <button onClick={() => onEdit(goal)} className="p-2 hover:bg-gray-200 rounded-lg transition-colors" title="Modifica">
              ...
              <button onClick={() => setConfirmDelete(true)} className="p-2 hover:bg-red-50 rounded-lg transition-colors" title="Elimina">
          ...
          {/* Desktop: status dropdown (hidden on mobile) */}
          {!isMobile && (
      ...
      >
        ...
        <div className="flex items-center justify-between pt-2 border-t border-gray-50">
          {isMobile ? (
            <div className="flex items-center gap-2">
              {prevStatus && (
                <button
                  onClick={() => onStatusChange(goal.id, prevStatus)}
                  className="text-xs bg-gray-100 text-gray-600 rounded-lg px-3 py-2 font-medium active:scale-95 transition-transform"
                >
              ...
              {nextStatus && (
                <button
                  ...
                  className="text-xs rounded-lg px-3 py-2 font-medium text-white active:scale-95 transition-transform"
                  style={{
          ...
          <div className="flex items-center gap-1">
            <button onClick={() => onEdit(goal)} className="p-2 hover:bg-gray-100 rounded-lg transition-colors" title="Modifica">
